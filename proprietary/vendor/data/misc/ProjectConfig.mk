...
# device/tinno/v730/ProjectConfig.mtk.mk
# vendor/tinno/common/journey/build/CommonProjectConfig.mk
# vendor/tinno/common/configs/TinnoProjectConfig.mk
# vendor/tinno/product/v730/sym_bd_z28/OdmProjectConfig.mk
# vendor/tinno/product/v730/sym_bd_z28/SUB_PROJECTS//OdmProjectConfig.sub.mk
# ../modem/mcu/make/projects/v730_sym_bd_z28/ProjectConfig.Modem.mk



####################
# content include from device/tinno/v730/ProjectConfig.mtk.mk
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_sunwin_v830_mipi_raw s5k3l6_tsp_v830_mipi_raw s5k4h7yx_sunwin_v830_mipi_raw s5k4h7yx_txd_v830_mipi_raw gc2375h_kmj_v830_mipi_raw gc2375h_hlt_v830_mipi_raw gc5035_sunwin_v830_mipi_raw gc5035_tsp_v830_mipi_raw gc5035_tsp_v730_mipi_raw gc5035_txd_v830_mipi_raw
CUSTOM_HAL_LENS = dw9718saf_s5k3l6_sunwin_v830 dw9718saf_s5k3l6_tsp_v830 dummy_lens
CUSTOM_HAL_MAIN3_IMGSENSOR = gc5035_sunwin_v830_mipi_raw gc5035_tsp_v830_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc2375h_kmj_v830_mipi_raw gc2375h_hlt_v830_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_sunwin_v830_mipi_raw s5k3l6_tsp_v830_mipi_raw
CUSTOM_HAL_MSENSORLIB = akl akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = s5k4h7yx_sunwin_v830_mipi_raw s5k4h7yx_txd_v830_mipi_raw gc5035_tsp_v730_mipi_raw gc5035_txd_v830_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_sunwin_v830_mipi_raw s5k3l6_tsp_v830_mipi_raw s5k4h7yx_sunwin_v830_mipi_raw s5k4h7yx_txd_v830_mipi_raw gc2375h_kmj_v830_mipi_raw gc2375h_hlt_v830_mipi_raw gc5035_sunwin_v830_mipi_raw gc5035_tsp_v830_mipi_raw gc5035_tsp_v730_mipi_raw gc5035_txd_v830_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9718saf_s5k3l6_sunwin_v830 dw9718saf_s5k3l6_tsp_v830 dummy_lens
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN3_IMGSENSOR = gc5035_sunwin_v830_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc2375h_kmj_v830_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l6_sunwin_v830_mipi_raw s5k3l6_tsp_v830_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k4h7yx_sunwin_v830_mipi_raw s5k4h7yx_txd_v830_mipi_raw gc5035_tsp_v730_mipi_raw gc5035_txd_v830_mipi_raw
...
CONFIG_T_PRODUCT_INFO = yes

# CJ:F2FS
JOURNEY_FEATURE_FS_F2FS = yes



####################
# content include from vendor/tinno/common/journey/build/CommonProjectConfig.mk
# Disdble duraspeed
MTK_DURASPEED_DEFAULT_ON = no
MTK_DURASPEED_SUPPORT = no

# Disable it for preventing MTK's unreasonable force stop 
MTK_HEAVY_LOADING_SUPPORT = no

# Disable CTA or any china feature
MTK_CTA_SUPPORT = no
# mtk mobile management
...
#fenghui.zou add for VHDAE-171,【TINNO_OPEN_PLATFORM_S0036】Remove "Data Protection" feature(MTK only)
MTK_CTA_SET = no
#fenghui.zou add end
...
####################
# content include from vendor/tinno/product/v730/sym_bd_z28/OdmProjectConfig.mk
# modify by wuhai for product build 20180831 begin
CUSTOM_BUILD_VERNO=Z28_HW2_V5
TCUSTOM_BUILD_VERNO=Z28_HW2_V5
INTERNAL_BUILD_VERNO=V730AN_10.0_M30_SYM_BD_Z28_V28

#add build for gms build
BUILD_GMS=yes

MYOS_CAMERA2=v830_trunk
MYOS_APECAMFACCALIBRATION_Q_FACEPLUSPLUS=v830_trunk
MYOS_APEPHOTOSEDITOR=v830_trunk
MYOS_FACEUNLOCK=v830_trunk

# enable SCC
FEATURE_TINNO_SCC = yes

CUSTOM_FTM_GYROSCOPE = no
...
####################
# content include from vendor/tinno/product/v730/sym_bd_z28/SUB_PROJECTS//OdmProjectConfig.sub.mk
# vendor/tinno/product/v730/sym_bd_z28/SUB_PROJECTS//OdmProjectConfig.sub.mk is not found


####################
# content include from ../modem/mcu/make/projects/v730_sym_bd_z28/ProjectConfig.Modem.mk
# ../modem/mcu/make/projects/v730_sym_bd_z28/ProjectConfig.Modem.mk is not found
